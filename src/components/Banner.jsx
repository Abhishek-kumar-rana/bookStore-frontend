...
// import booklover from './../../public/booklover.svg'
  ...
  return (
    ...
    <div className=' my-10 max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row'>
        <div className='order-2 md:order-1  w-full md:w-1/2 mt-12 md:mt-32'>
            ...
            <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto facere iure vitae voluptatum itaque neque fugiat, tempora inventore! Tempora neque modi voluptatum quod corporis tenetur?
            </p>
