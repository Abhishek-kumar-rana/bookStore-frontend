                                            ...
                                            <div className="flex flex-wrap -mx-4 mb-6">
                                                ...
                                                <div className="w-full lg:w-1/2 px-4 mb-6 lg:mb-0">
                                                    <div>
                                                        ...
                                                        <input name='name' value={formData.name} onChange={handleChange} className="w-full py-3 px-4 text-sm text-gray-900 dark:bg-base-content dark:text-white placeholder-gray-400 border border-gray-200 focus:border-purple-500 focus:outline-purple rounded-lg" type="text" placeholder="eg. Lavin Gemipit" />
                                                    </div>
                                                </div>
                                                <div className="w-full lg:w-1/2 px-4">
                                                    <div>
                                                        ...
                                                        <input name='email' value={formData.email} onChange={handleChange} className="w-full py-3 px-4 text-sm text-gray-900 dark:bg-base-content dark:text-white placeholder-gray-400 border border-gray-200 focus:border-purple-500 focus:outline-purple rounded-lg" type="text" placeholder="Type your email" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="mb-9">
                                                ...
                                                <textarea name='message' value={formData.message} onChange={handleChange} className="w-full h-12 py-3 px-4 resize-none text-sm text-gray-900 dark:bg-base-content dark:text-white placeholder-gray-400 border border-gray-200 focus:border-purple-500 focus:outline-purple rounded-lg" type="text" placeholder="Type your message"></textarea>
                                            </div>
